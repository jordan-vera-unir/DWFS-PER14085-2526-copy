  ...
  //Aqui tu codigo
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            let R = obtenerPixeles[0];
            let G = obtenerPixeles[1];
            let B = obtenerPixeles[2];

            let media = (R + G + B) / 3;

            obtenerPixeles[0] = media;
            obtenerPixeles[1] = media;
            obtenerPixeles[2] = media;
    ...
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            if (media < 128) {
                ...
                // Blanco
                obtenerPixeles[0] = 255;
                obtenerPixeles[1] = 255;
                obtenerPixeles[2] = 255;
            }
  ...
  //Aqui tu codigo
    ...
    for (let i = 0; i < pixels.length; i++) {
        if (i % 2 === 0) {
            ...
            for (let j = 0; j < pixels[i].length; j++) {
                if (j % 2 === 0) {
                    filaPixel.push(pixels[i][j]);
                }
            }

            nuevoPixel.push(filaPixel);
        }
    }


  handler.savePixels(nuevoPixel, outputPath, handler.getShape()[0] / 2, handler.getShape()[1] / 2);
}
  ...
  //Aqui tu codigo
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            obtenerPixeles[0] /= dimFactor;
            obtenerPixeles[1] /= dimFactor;
            obtenerPixeles[2] /= dimFactor;
  ...
  //Aqui tu codigo
    for (let i = 0; i < pixels.length; i++) {
        for (let j = 0; j < pixels[i].length; j++) {
            ...
            let obtenerPixeles = pixels[i][j];
            obtenerPixeles[0]=255 - obtenerPixeles[0];
            obtenerPixeles[1]=255 - obtenerPixeles[1];
            obtenerPixeles[2]=255 - obtenerPixeles[2];
